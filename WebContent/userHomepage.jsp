		...
		<div class="container text-center">
			<div class="row">
				<div class="col-md-7 col-sm-12">
					<h6>FOOD DELIVERY: DAILY ORDERS</h6>
					<h1>CHICKEN WINGS</h1>
					...
					<button class="btn btn-light px-5 py-2">Buy now for RS.150</button>
				</div>
...
<section class="section-3 container-fluid p-0 text-center">
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<h1>Downoad Our App For All Platforms</h1>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
...
<section class="section-4">
	<div class="container">
		<h1 class="text-dark text-center">What our readers say about us</h1>
		<p class="text-secondary text-center">Lorem ipsum dolor sit amet.</p>
	</div>
  ...
  <div class="col-md-4 col-12 text-center">
    <div class="card mr-2 d-inline-block shadow-lg">
    	<div class="card-img-top">
    		<img src="images/t1.jpg" class="img-fluid border-radius p-4">
    	</div>

      <div class="card-body">
        <h3 class="card-title">Tharun Kumar</h3>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active text-center">
      <div class="card mr-2 d-inline-block shadow-lg">
    	<div class="card-img-top">
    		<img src="images/t1.jpg" class="img-fluid rounded-circle w-50 p-4">
    	</div>

      <div class="card-body">
        <h3 class="card-title">H Tharun Kumar</h3>
        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
        <a href="#" class="text-secondary text-decoration-none">Go somewhere</a>
        <p class="text-black-50">CEO at Google</p>
      </div>
		...
		<div class="container-fluid p-0">
			<div class="row text-left">
				<div class="col-md-5">
					...
					tempor incididunt ut labore et dolore magna aliqua. </p>
					<p class="pt-4 text-muted">copyright @2019 all rights reserved by</p>
					<span>Online Food Delivery</span>
				</div>
				<div class="col-md-5">
					<h4 class="text-light">newsletter</h4>
					<p class="text-muted">Hungry</p>
